...
<section Class="col-md-4 col-sm-6 col-10 mx-auto mt-3">
	...
	<form action="<?= BASE_URL; ?>/projects/<?= $project->id; ?>/update" method="post" enctype="multipart/form-data">
		...
		<div class="mb-3 form-check form-switch">
			<input class="form-check-input" name="visible" type="checkbox" id="switch" <?php echo !$project->visible ?: 'checked'; ?>>
			<label for="switch" class="form-check-label">Visible</label>
		</div>
		<div class="mb-3">
