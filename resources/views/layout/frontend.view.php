...
<html lang="en">
    <head>
        ...
        <title><?= $site->title ?? 'Portfolio' ?> - <?= $site->tagline ?? '' ?></title>

        <!-- Favicon-->
        <link rel="icon" type="image/svg+xml" href="<?= BASE_URL; ?>/assets/favicon.svg" />
        <link rel="alternate icon" type="image/png" href="<?= BASE_URL; ?>/assets/favicon.png" />
        <!-- Google fonts-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="<?= BASE_URL; ?>#page-top"><?= $site->title ?? 'Portfolio' ?></a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0"><?= $this->e($site->credit ?? '') ?></p>
                    </div>
                </div>
            </div>
        </footer>
